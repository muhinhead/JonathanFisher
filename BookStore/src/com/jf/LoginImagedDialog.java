...
//    private static IMessageSender exchanger;
    ...
    protected void fillContent() {
        BookStore.setWindowIcon(this, "bs.png");
        okPressed = false;
        buildMenu();
        try {
            String theme = BookStore.readProperty("LookAndFeel",
...
//        BookStore.setExchanger(exchanger);
        loginField = new Java2sAutoComboBox(BookStore.loadAllLogins("login"));
        ...
        ImagePanel img = new ImagePanel(BookStore.loadImage(BACKGROUNDIMAGE, this));
        addNotify();
        ...
        img = new ImagePanel(BookStore.loadImage(LOCKIMAGE, this));
        ...
        if (pwdmd5.trim().length() > 0) {
            loginField.setSelectedItem(BookStore.readProperty("Lastlogin", ""));
        }
    ...
    private void buildMenu() {
        ...
        m.add(new JMenuItem(new AbstractAction("Settings") {
            ...
            public void actionPerformed(ActionEvent e) {
                BookStore.configureConnection();
//                String newAddress = BookStore.serverSetup("Options");
//                if (newAddress != null) {
//                    BookStore.getProperties().setProperty("ServerAddress", newAddress);
//                    try {
//                        BookStore.setExchanger(
//                                (IMessageSender) Naming.lookup("rmi://"
//                                + newAddress + "/AIBserver"));
//                    } catch (Exception ex) {
//                        BookStore.logAndShowMessage(ex);
//                        System.exit(1);
//                    }
//                }
            }
...
//        });
    ...
    private void setLookAndFeel(String lf) throws ClassNotFoundException,
        ...
        SwingUtilities.updateComponentTreeUI(this);
        BookStore.getProperties().setProperty("LookAndFeel", lf);
        BookStore.saveProps();
    }
        ...
        return new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    DbObject[] users = BookStore.getExchanger().getDbObjects(User.class,
                    ...
                    if (isOkPressed()) {
                        ...
                        BookStore.setCurrentUser(currentUser);
                        dispose();
                    } else {
