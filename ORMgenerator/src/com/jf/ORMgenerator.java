...
import com.jf.dbstructure.Column;
import com.jf.dbstructure.ForeignKey;
import com.jf.dbstructure.NotForeignKeyDescribingLineException;
import com.jf.dbstructure.NotTableDescribingLineException;
import com.jf.dbstructure.Table;
import com.jf.dbstructure.Type;
...
public class ORMgenerator {
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage:\n\tjava com.xlend.jf.ORMGenerator <creating_database.sql> <output directory> [package_name]");
        } else {
            try {
