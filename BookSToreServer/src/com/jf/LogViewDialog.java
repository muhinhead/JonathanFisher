...
//    private String dbVersion;
    ...
    public LogViewDialog(String serverVerion, String dbVersion) {
        super(null, "BookStore Server Log", new String[]{serverVerion, dbVersion});
        BookStoreServer.setWindowIcon(this, "bs.png");
    }

    @Override
    protected Color getHeaderBackground() {
        return BookStoreServer.getUnformColor();
    }
...
//        dbVersion = versions[1];
    ...
    public boolean sendLog(String email) {
        ...
        String SUBJECT = "BookStoreServer server version:" + versions[0]
